<html>
    ...
    <body>
        ...
        function initMap() {
            var latitude = 26.73042229389175;
            var longitude = 85.92566549777985;
        ...
        async defer></script>
          ...
          <p align="center"style="color:black;font-size:22px;"><b>Please Select and Submit Your Current location on Map:</b></p>
            <table align="right">
            	<br>
